...
// ANSWER: break down the function in group discussion.
...
/*
  ...
  We'll be calculating factorials in this class 
    - factorial is a number multiplied by all the numbers 
      below it besides 0
    - so the factorial of 4 is 24, which is 4*3*2*1 - 1 
...
// // CODE HERE 
function postNums2(num1, num2, num3) {
  let answer = num1 * num2* num3
  return answer
}
// /*
